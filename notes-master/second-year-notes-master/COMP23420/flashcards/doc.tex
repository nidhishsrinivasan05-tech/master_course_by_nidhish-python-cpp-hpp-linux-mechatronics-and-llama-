...
\card{
	...
	and interactions go horizontally between vertical lines below them.
}

\card{
	What is an activity diagram?
}{
	An activity diagram describes what the system should do, not how it does it.
...
\card{
	...
	A non-decomposable piece of behaviour.
}
...
\card{
	...
	A criteria that is used to judge the operation of a system rather than
	specific behaviours.
}
